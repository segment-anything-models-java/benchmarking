...
#DEEPBACS_JSON_DIR = "/home/carlos/Videos/QuPath-v0.6.0-Linux/deepbacs/results/deepbacs_save"
DEEPBACS_JSON_DIR = "/home/carlos/Desktop/RESULTS_QUPATH/deepbacs_save"
DEEPBACS_MASK_DIR = "/home/carlos/Pictures/samj_rebuttal/deepbacs/ims/mask"
RES_FILE = "/home/carlos/eclipse-workspace-test/scripts/res_qupath_second/deepbacs.csv"
os.makedirs(os.path.dirname(RES_FILE), exist_ok=True)

all_files = os.listdir(DEEPBACS_MASK_DIR)
all_files.sort()
...
f_names = []
for row_idx, mask_name in enumerate(all_files):
    print(row_idx)
    gf_name = mask_name
    f_names.append(mask_name)
    mask = tifffile.imread(os.path.join(DEEPBACS_MASK_DIR, mask_name))
    ...
    for i_model, model in enumerate(models):
        ...
        gm_path = os.path.join(DEEPBACS_JSON_DIR, gm_name)
...
"""
scores_mat.mean(0)
array([0.29109523, 0.59254742, 0.28869433, 0.58779223, 0.28483598,
       0.57806314, 0.28586126, 0.57606186])
"""
