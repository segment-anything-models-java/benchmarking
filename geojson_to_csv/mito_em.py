...
MITOEM_JSON_DIR = "/home/carlos/Desktop/RESULTS_QUPATH/neurips_save"
MITOEM_MASK_DIR = ...
RES_FILE = "/home/carlos/eclipse-workspace-test/scripts/res_qupath_second/mito_em.csv"
os.makedirs(os.path.dirname(RES_FILE), exist_ok=True)

all_files = os.listdir(MITOEM_MASK_DIR)
all_files.sort()
...
for row_idx, mask_name in enumerate(all_files):
    ...
    mask = tifffile.imread(os.path.join(MITOEM_MASK_DIR, mask_name))
    ...
    for i_model, model in enumerate(models):
        ...
        gm_path = os.path.join(MITOEM_JSON_DIR, gm_name)
